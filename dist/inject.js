...
/* harmony import */ var _services_onvix__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./services/onvix */ "./src/services/onvix.ts");
/* harmony import */ var _services_kinopub__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./services/kinopub */ "./src/services/kinopub.ts");
/* harmony import */ var _services_youtube__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./services/youtube */ "./src/services/youtube.ts");
/* harmony import */ var _services_netflix__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./services/netflix */ "./src/services/netflix.ts");
/* harmony import */ var _subs__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./subs */ "./src/subs.ts");
        ...
        if (document.readyState === "complete") {
                ...
                videoElement.addEventListener("loadstart", () => {
                    ...
                    service.getSubs("eng")
                        ...
                        videoElement.ontimeupdate = () => {
                            _subs__WEBPACK_IMPORTED_MODULE_5__["default"].updateSubs(videoElement, subs, subsElement);
                            _subs__WEBPACK_IMPORTED_MODULE_5__["default"].updateSubsProgressBar(subsProgressBarElement, videoElement, subs);
                        };
                        ...
                        document.addEventListener("keyup", (event) => {
                            if (event.code == "ArrowLeft") {
                                ...
                                _video__WEBPACK_IMPORTED_MODULE_6__["default"].moveToPrevSub(videoElement, subs, subsProgressBarElement);
                            }
                            if (event.code == "ArrowRight") {
                                event.stopPropagation();
                                _video__WEBPACK_IMPORTED_MODULE_6__["default"].moveToNextSub(videoElement, subs, subsProgressBarElement);
                            }
                        }, true);
                        ...
                        const resizeObserver = new ResizeObserver(() => {
                            _subs__WEBPACK_IMPORTED_MODULE_5__["default"].updateSubsProgressBar(subsProgressBarElement, videoElement, subs, true);
                        });
            ...
            function detectService() {
                ...
                if (titleContent.includes("YouTube") || window.location.host == "www.youtube.com") {
                    return new _services_youtube__WEBPACK_IMPORTED_MODULE_3__["default"];
                }
                else if (titleContent.includes("Netflix") || window.location.host == "www.netflix.com") {
                    return new _services_netflix__WEBPACK_IMPORTED_MODULE_4__["default"];
                }
                else if (titleContent.includes("Onvix") || document.querySelector('meta[content="ONVIX"]')) {
                    return new _services_onvix__WEBPACK_IMPORTED_MODULE_1__["default"];
                }
                else if (titleContent.includes("Кинопаб") || document.querySelector('meta[content="Кинопаб"]')) {
                    return new _services_kinopub__WEBPACK_IMPORTED_MODULE_2__["default"];
                }
                else {
                    return null;
                }
...
class KinoPub {
    ...
    createSubsTranslateElement(subs, originalText, translatedText) {
