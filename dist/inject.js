    ...
    subsWordMouseOver(event) {
        ...
        if (element.className === 'easysubs-word') {
            ...
            chrome.runtime.sendMessage({ contentScriptQuery: 'getSingleTranslation', text: words[0], lang: "ru" }, (response) => {
                ...
                _ui__WEBPACK_IMPORTED_MODULE_2__["default"].setTranslation(this.translateContainerElement, this.translateOriginalElement, this.translateResultElement, words[0], translates[0][0]);
            });
        }
    }
