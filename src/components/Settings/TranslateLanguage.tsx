...
import { AriaSelectProps } from '@solid-aria/select'
import { Item } from '@solid-aria/collection'
import { ItemKey } from '@solid-aria/types'

import { Select } from '@/components/ui'
import { $translateLanguage, setTranslateLanguageFx } from '@/models/global'

export const TranslateLanguage: Component<AriaSelectProps> = (props) => {
  const translateLanguage = useUnit($translateLanguage)

  const updateTranslateLanguage = (key: ItemKey) => {
    setTranslateLanguageFx(String(key))
  }
